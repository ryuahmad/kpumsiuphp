...
if(isset($_POST['add_user'])) {
   ...
   if($nim == '' || $nama == '' || $jk == '' || $kls == '' || $level == '') {
      ...
      $sql = $con->prepare("INSERT INTO t_user(id_user, fullname, id_kelas, jk, level) VALUES(?, ?, ?, ?, ?)");
      $sql->bind_param('ssss', $nim, $nama, $kls, $jk, $level);
      $sql->execute();
...
?>
<h3>Tambah Data Manajemen/Dosen</h3>
<hr />
<div class="row">
    <div class="col-md-8 col-sm-12">
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">NIDN/NIK</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Nama Manajemen/Dosen</label>
                <div class="col-md-8">
                    <input class="form-control" name="nama" type="text" placeholder="Nama Manajemen/Dosen"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="kelas" required="kelas" class="form-control">
                        ...
                        <?php
                            $kelas = mysqli_query($con, "SELECT * FROM t_kelas WHERE id_kelas >= 24");
                            while ($key = mysqli_fetch_array($kelas)) {
                            ?>
                                <option value="<?php echo $key['id_kelas']; ?>">
                                    <?php echo $key['kode_kelas']; ?>
                                </option>
                                <?php
                            }
                        ?>
            ...
            <div class="form-group">
                <div class="col-md-8 col-md-offset-2">
                    <button type="submit" name="add_user" value="Tambah User" class="btn btn-success">Tambah Manajemen/Dosen</button>
