   ...
   <div class="col-md-10 col-sm-12">
      <table class="table table-striped table-hover">
            ...
            <tbody>
                  ...
                  $sql = mysqli_query($con, "SELECT * FROM t_pemilih JOIN t_user ON t_pemilih.nim = t_user.id_user WHERE level = 'dosen' LIMIT $start,100");
      ...
      ?>
            <li class="waves-effect">
               <a href="?page=pemilihdosen&hlm=<?php  echo $hlmn; ?>">
      ...
      <?php
         ...
         $hitung = mysqli_num_rows(mysqli_query($con, "SELECT * FROM t_pemilih JOIN t_user ON t_pemilih.nim = t_user.id_user WHERE level = 'dosen'"));

         $total  = ceil($hitung / 100);
         for ($i = 1; $i <= $total ; $i++) { //start for
      ?>
            <li <?php if ($hlm != $i) { echo 'class="waves-effect"'; } else { echo 'class="active"'; } ?>>
               <a href="?page=pemilihdosen&hlm=<?php  echo $i; ?>">
                  <?php  echo $i; ?>
               </a>
            </li>
         <?php
         ...
         ?>
            <li class="waves-effect">
               <a href="?page=pemilihdosen&hlm=<?php  echo $next; ?>">
