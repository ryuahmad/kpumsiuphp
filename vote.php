...
<html>
   ...
   <body>
      <div class="container">
         ...
         $sql = $con->prepare("SELECT * FROM t_paslon WHERE periode = ?") or die($con->error);
         ...
         if ($sql->num_rows() > 0) {
            ...
            <div class="text-center" style="padding-top:20px;">
                     <h2>Daftar Calon Presiden & Wakil Presiden Mahasiswa Periode '.$periode.'</h2>
                  </div>
                  <hr />';
            ...
            echo '<div class="col-md-10 col-md-offset-1">';
               ...
               for ($i = 1; $i <= $numb; $i++) {
                  $sql->bind_result($id, $nama, $foto, $visi, $misi, $vote, $periode);
                  $sql->fetch();
         ?>
                  <div class="col-md-4">
                      ...
                      <div class="thumbnail">  
                        <div class="text-center">
                           ...
                           <div class="caption">
                              ...
                              <a href="./submit.php?id=<?php echo $id; ?>&s=<?php echo $vote; ?>" class="btn btn-success btn-block">Beri Suara</a>
                           </div>
                          </div>
                        </div>
                     </section>
